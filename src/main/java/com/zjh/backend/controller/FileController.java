...
import com.zjh.backend.rabbitmq.producter.MessageProducter;
...
//    private CosManager cosManager;
    ...
    public Result uploadFileMq(@RequestPart("file") MultipartFile multipartFile,
                             GenChartByAiRequest genChartByAiRequest, HttpServletRequest request) {
        ...
        long newChartId = genChartData.getId();
        messageProducter.sendMessage(BIMQConstant.BI_EXCHANGE_NAME, BIMQConstant.BI_ROUTING_KEY, String.valueOf(newChartId));
